...
export default function Edit_task_page(){
        ...
        <div className="block_page_create_test">
            <div >
                <Card className="card_form_create_test">
                                    <Card.Header>
                                        <h3>Редактировать пункт</h3></Card.Header>
                                    <Card.Body><div>
                                    ...
                                    <div className='form_element_2'>
                                        ...
                                        <Button type="submit" className="tasks_buttons_style" variant="dark" size="lg">Редактировать подраздел</Button>
                                    </form>
                                </div></Card.Body>
                                </Card>
            </div>
