        ...
        <div className="block_page_2">
            ...
            <Card className="cardStyle_2">
                ...
                <div className="form_element" >
                    ...
                    <select className="select_style_admin_page" id="role" name="role" value={formData.role} onChange={handleChange}>
                    <option value="Admin">Админ</option>
                    <option value="Moderator">Модератор 1</option>
                    <option value="Moderator">Модератор 2</option>
                    <option value="Moderator">Модератор 3 </option>
