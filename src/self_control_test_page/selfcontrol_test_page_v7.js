...
import data_json from "./data_self_control.json"


export default function Self_control_v8(){
        ...
        <Container>
            ...
            {selectedSection !== null && (
                <div>
                    ...
                    <Button variant="success" onClick={handleSubmitLevel} className="mt-2 me-2">
                        Отправить уровень
                    </Button>

                    <Button variant="primary" onClick={handleNextLevel} className="mt-2">
                        Следующий уровень
                    </Button>
